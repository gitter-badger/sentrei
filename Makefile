...
encrypt:
	...
	gpg --symmetric --cipher-algo AES256 android/key/sentrei-alpha.json
	gpg --symmetric --cipher-algo AES256 android/key/sentrei-beta.json
	gpg --symmetric --cipher-algo AES256 android/key/sentrei-master.json
